...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "update  delivery set Job='$job',Queuedate='$queuedate',Deliverydate='$deliverydate',Type='$type',Staff='$staff',Cname='$cname',Cphone='$cphone',Cchanel='$cchanel',Clocation='$clocation',Area='$area',Route='$route',Clink='$clink',Item='$item',Qty='$qty',Other='$other' where ID='$eid'");
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="other" value="<?php echo $row['Other']; ?>" placeholder="หมายเหตุ (ถ้ามี)">
                                        </div>
                                    </div>
                                </div>
                            </div>

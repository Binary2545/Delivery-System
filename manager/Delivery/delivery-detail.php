    ...
    <div id="main-wrapper">
        ...
        <?php
            ...
            <div class="border-top">
                ...
                <!--<a href="" class="edit" data-toggle="tooltip"><button type="button" class="btn btn-info"><i class="mdi mdi-map-marker-radius"></i> Link Location</button></a>-->
                </div>
            </div>
            <!-- ============================================================== -->
                            ...
                            <div class="card">
                                <form class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">หมายเหตุ (การขนส่ง)</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="<?php echo $row['Remark']; ?>" placeholder="" disabled>
                                            </div>
                                        </div>

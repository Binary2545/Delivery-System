...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            <?php
            $vid = $_GET['viewid'];
            $ret = mysqli_query($con, "select * from customer where ID =$vid");
            $cnt = 1;
            ...
            ?>
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">รายละเอียดรายชื่อลูค้า <span class="badge badge-success">#<?php echo $row['ID']; ?></span></h4>
                ...
                <div class="border-top">
                    <div class="card-body">
                        <a href="customer-edit.php?editid=<?php echo htmlentities($row['ID']); ?>" class="edit" data-toggle="tooltip"><button type="button" class="btn btn-warning">แก้ไขรายการ</button></a>
                                ...
                                <form class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="fname" class="col-sm-2 text-right control-label col-form-label">Customer No.</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Customer No." value="<?php echo $row['ID']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="fname" class="col-sm-2 text-right control-label col-form-label">ชื่อลูกค้า</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="ชื่อลูกค้า" value="<?php echo $row['Name']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">เบอร์โทรติดต่อ</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="เบอร์โทรติดต่อ" value="<?php echo $row['Phone']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">ช่องทางติดต่อ</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="ช่องทางติดต่อ" value="<?php echo $row['Chanel']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1" class="col-sm-2 text-right control-label col-form-label">สถานที่จัดส่ง</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="สถานที่จัดส่ง" value="<?php echo $row['Location']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1" class="col-sm-2 text-right control-label col-form-label">สถานที่จัดส่ง</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Link Location" value="<?php echo $row['Link']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">

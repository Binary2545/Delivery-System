...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "update  customer set Name='$name',Phone='$phone',Chanel='$chanel',Location='$location',Link='$link',Other='$other' where ID='$eid'");
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ?>
            <?php
            $eid = $_GET['editid'];
            $ret = mysqli_query($con, "select * from customer where ID='$eid'");
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">แก้ไขรายชื่อลูค้า <span class="badge badge-warning"># <?php echo $row['ID']; ?></span></h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="name" placeholder="ชื่อลูกค้า" value="<?php echo $row['Name']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">เบอร์โทรติดต่อ</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="phone" placeholder="เบอร์โทรติดต่อ" value="<?php echo $row['Phone']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">ช่องทางติดต่อ</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="chanel" placeholder="ช่องทางติดต่อ" value="<?php echo $row['Chanel']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1" class="col-sm-2 text-right control-label col-form-label">สถานที่จัดส่ง</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="location" placeholder="สถานที่จัดส่ง" value="<?php echo $row['Location']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1" class="col-sm-2 text-right control-label col-form-label">Link Location</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="link" placeholder="สถานที่จัดส่ง" value="<?php echo $row['Link']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1" class="col-sm-2 text-right control-label col-form-label">หมายเหตุ</label>
                                            <div class="col-sm-10">
                                                <textarea type="text" class="form-control" name="other" placeholder="หมายเหตุ" value="<?php echo $row['Other']; ?>"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <?php
                            $ret = mysqli_query($con, "select * from delivery  WHERE Cstatus='Complete' limit 5");
                            $cnt = 1;
                    ...
                    <div class="card">
                            <?php
                            $ret = mysqli_query($con, "select * from delivery  WHERE Cstatus='รอ รับ/ส่ง สินค้า' limit 5");
                            $cnt = 1;
                            $row = mysqli_num_rows($ret);
                            if ($row > 0) {
                                while ($row = mysqli_fetch_array($ret)) {
                            ...
                            ?>
                                    <div class="card-body" style="background-color: orange;">
                                        <h4 class="card-title" style="color:aliceblue;">รายการรับ-ส่งสินค้า</h4>
                                    </div>
                                    <div class="comment-widgets scrollable">

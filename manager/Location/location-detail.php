...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="location-report.php" aria-expanded="false"><i class="mdi mdi-map-marker-radius"></i><span class="hide-menu">สถานที่</span></a></li>
        ...
        <?php
            $vid = $_GET['viewid'];
            $ret = mysqli_query($con, "select * from location where ID =$vid");
            $cnt = 1;
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title">รายละเอียดสถานที่จัดส่ง <span class="badge badge-success"># <?php echo $row['ID']; ?></span></h4>
            ...
            <div class="border-top">
                <div class="card-body">
                <a href="location-edit.php?editid=<?php echo htmlentities($row['ID']); ?>" class="edit" data-toggle="tooltip"><button type="button" class="btn btn-warning">แก้ไขรายการ</button></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    <h4 class="card-title">ข้อมูลสถานที่</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">Location No.</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="Location No." value="<?php echo $row['ID']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">อำเภอ</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="อำเภอ" value="<?php echo $row['Area']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">เส้นทางเดินรถ</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="เส้นทางเดินรถ" value="<?php echo $row['Route']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">หมายเหตุ</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="หมายเหตุ" value="<?php echo $row['Other']; ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </form>

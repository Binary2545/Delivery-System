...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "insert into location(Area,Route,Other) value('$area','$route','$other') ");
}
?>
...
<body>
    ...
    <div id="main-wrapper">
        ...
        if ($query) {
            ...
            <a href="location-report.php"> กลับหน้าหลัก </a>
          </div>';
        } else {
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">เพิ่มสถานที่จัดส่ง</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="area" placeholder="อำเภอ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">เส้นทางเดินรถ</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="route" placeholder="เส้นทางเดินรถ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">หมายเหตุ</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="other" placeholder="หมายเหตุ">
                                        </div>
                                    </div>
                                </div>
                            </div>

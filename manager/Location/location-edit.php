...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "update  location set Area='$area',Route='$route',Other='$other' where ID='$eid'");
    if ($query) {
        echo "<script>alert('สร้างรายการขายเรียบร้อย');</script>";
        echo "<script type='text/javascript'> document.location ='location-report.php'; </script>";
    } else {
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            <?php
            $eid = $_GET['editid'];
            $ret = mysqli_query($con, "select * from location where ID='$eid'");
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">แก้ไขสถานที่ <span class="badge badge-warning">#0000001</span></h4>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="area" placeholder="อำเภอ" value="<?php echo $row['Area']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">เส้นทางเดินรถ</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="route" placeholder="เส้นทางเดินรถ" value="<?php echo $row['Route']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">หมายเหตุ</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="other" placeholder="เส้นทางเดินรถ" value="<?php echo $row['Other']; ?>">
                                            </div>
                                        </div>
                                    </div>

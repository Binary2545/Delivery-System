						...
						<div class="panel-body">
							...
							<div class="row">
                                ...
                                <div class="col-sm-4 top-left">
                                    <div class="col-lg-12">
										<p style="font-size: 13px">บริษัท บิ๊กแมน อิเล็กทรอนิค จำกัด</p>
										<p style="font-size: 13px">190/19 หมู่ที่ 5 ตำบลรัษฎา อำเภอเมืองภูเก็ต จังหวัดภูเก็ต 83000</p>
										<p style="font-size: 13px">เลขประจำตัวผู้เสียภาษี 0835563003372</p>
										<p style="font-size: 13px">เบอร์ติดต่อ 095-449-6141</p>
										<p style="font-size: 13px">อีเมล์ Bigman.etn4289@gmail.com</p>
									</div>
								</div>
								<div class="col-sm-4 top-center">
									<h3 style="text-align:center"><img onclick="window.print()" src="logo.png" alt="" style="width: 200px;"></h3>
								</div>

								<div class="col-sm-4 top-right">
                                    <h3 class="marginright">ใบงานรับ/ส่ง สินค้า</h3>
									<h3 class="marginright"><?php echo date("d/m/y") ?></h3>
								</div>

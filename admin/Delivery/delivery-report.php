        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                    <div class="card-body">
                    <a href="delivery-add.php"><button type="button" class="btn btn-info"><i class="mdi mdi-plus-circle"></i> เพิ่มการขนส่ง</button></a>
                    <a href="waitdelivery.php"><button type="button" class="btn btn-warning"><i class="mdi mdi-note-plus"></i> รอจัดส่ง</button></a>
                    <a href="queue.php"><button type="button" class="btn btn-secondary"><i class="mdi mdi-note-plus"></i> ลงคิว</button></a>
                    <a href="complete.php"><button type="button" class="btn btn-success"><i class="mdi mdi-note-plus"></i> Complete</button></a>
                    </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>ผู้ลงคิว</th>
                                                <th>หมายเหตุ</th>
                                                <th>หมายเหตุ(ขนส่ง)</th>
                                                <th>แสดงผล</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                    $ret = mysqli_query($con, "select * from delivery ORDER BY ID DESC");
                                    $cnt = 1;
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['Sentdate']; ?><br><span class="badge badge-pill badge-secondary"><?php echo $row['Mile']; ?></span><br><span class="badge badge-pill badge-success"><?php echo $row['Time']; ?></span></td>

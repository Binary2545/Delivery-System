            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">สถานะการขนส่ง</h4>
                ...
                <div class="row">
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="fname" placeholder="Job No." disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="toys" id="toy-id" disabled>
                                                <option value="">เลือกประเภทการขนส่ง</option>
                                                <option value="Mechanical Doll">รับสินค้า</option>
                                                <option value="Remote Car">ส่งสินค้า</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="toys" id="toy-id" disabled>
                                                <option value="">ผู้ลงคิว</option>
                                                <option value="Mechanical Doll">พี่แมน</option>
                                                <option value="Remote Car">พี่มาย</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="fname" placeholder="ชื่อลูกค้า" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">เบอร์โทร</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="" placeholder="เบอร์โทรติดต่อ" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="toys" id="toy-id" disabled>
                                                ...
                                                <option value="Mechanical Doll">Line</option>
                                                <option value="Remote Car">Facebook</option>
                                                <option value="Remote Car">Phone</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="" placeholder="สถานที่จัดส่ง" disabled>
                                        </div>
                                    </div>
                                    <!--<div class="form-group row">
                                        <label for="email1" class="col-sm-2 text-right control-label col-form-label">สถานะ</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" name="toys" id="toy-id">
                                                <option value="">สถานะการขนส่ง</option>
                                                <option value="Mechanical Doll">ลงคิว</option>
                                                <option value="Remote Car">รอ รับ/ส่ง สินค้า</option>
                                                <option value="Remote Car">Complete</option>
                                            </select>
                                        </div>
                                    </div>-->
                                </div>
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="fname" placeholder="รายการสินค้า" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">จำนวน</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="" placeholder="จำนวน" disabled>
                                        </div>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">ยืนยันการจัดส่ง</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">วันที่จัดส่ง</label>
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="fname" placeholder="รายการสินค้า">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-2 text-right control-label col-form-label">สถานะ</label>

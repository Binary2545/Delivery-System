...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "insert into delivery(Job,Queuedate,Deliverydate,Sentdate,Type,Staff,Cname,Cphone,Cchanel,Clocation,Clink,Cstatus,Area,Route,Item,Qty,Other) value('$job','$queuedate','$deliverydate','$sentdate','$type','$staff','$cname','$cphone','$cchanel','$clocation','$clink','$cstatus','$area','$route','$item','$qty','$other') ");
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">เพิ่มการขนส่ง</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">การจัดส่ง</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">เพิ่มการขนส่ง</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" name="cname" placeholder="ชื่อลูกค้า" required>
                                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target=".bd-example-modal-lg-customer">ค้นหา</button>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">เบอร์โทร</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="phone" name="cphone" placeholder="เบอร์โทรติดต่อ" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">ช่องทาง</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="chanel" name="cchanel" placeholder="เบอร์โทรติดต่อ" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-2 text-right control-label col-form-label">สถานที่ </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="location" name="clocation" placeholder="สถานที่จัดส่ง" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">Link Location</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="link" name="clink" placeholder="Link Location">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="cstatus" required>
                                                <option value="">สถานะการขนส่ง</option>
                                                <option value="ลงคิว">ลงคิว</option>
                                                <option value="รอ รับ/ส่ง สินค้า">รอ รับ/ส่ง สินค้า</option>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="job" placeholder="Job No.">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">วันที่ลงคิว</label>
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" name="queuedate" placeholder="<?php date("d/m/y") ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">วันที่นัดส่ง</label>
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" name="deliverydate" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="type" required>
                                                <option value="">เลือกประเภทการขนส่ง</option>
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-2 text-right control-label col-form-label">ผุ้ลงคิว</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="staff" placeholder="ผู้ลงคิว" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">จุดรับ/ส่งสินค้า</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="area" name="area" placeholder="เขตพื้นที่/อำเภอ" required>
                                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target=".bd-example-modal-lg-location">ค้นหา</button>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">เส้นทางเดินรถ</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="route" name="route" placeholder="เส้นทางเดินรถ" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">รายการสินค้า</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="item" placeholder="รายการสินค้า" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control" name="other" placeholder="หมายเหตุ (ถ้ามี)"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <a href="../customer/customer-add.php"><button type="button" class="btn btn-success">เพิ่ม</button></a>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="table-responsive">
                                        <table class id="customer" class="table table-striped table-bordered" style="width:100%; overflow-x:auto;">
                                            <thead>
                                                <tr>
                                                    <th>ชื่อที่ติดต่อ</th>
                                                    <th>เบอร์โทร</th>
    ...
    <div class="modal fade bd-example-modal-lg-location" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <a href="../location/location-add.php"><button type="button" class="btn btn-success">เพิ่ม</button></a>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <table id="ways" class="table table-striped table-bordered" style="width:100%; overflow-x:auto;">
                                            <thead>
                                                <tr>
                                                    <th>เขตพื้นที่</th>
                                                    <th>เส้นทางเดินรถ</th>
    ...
    <script>
        ...
        for (var i = 1; i < table.rows.length; i++) {
            table.rows[i].onclick = function() {
                ...
                document.getElementById("chanel").value = this.cells[2].innerHTML;
                document.getElementById("location").value = this.cells[3].innerHTML;
                document.getElementById("link").value = this.cells[4].innerHTML;
            };
        }
    </script>

    <script>
        var table = document.getElementById('ways');

        for (var i = 1; i < table.rows.length; i++) {
            table.rows[i].onclick = function() {
                //rIndex = this.rowIndex;

                document.getElementById("area").value = this.cells[0].innerHTML;

...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "insert into customer(Name,Phone,Chanel,Location,Link,Other) value('$name','$phone','$chanel','$location','$link','$other') ");
}
?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="location" placeholder="สถานที่จัดส่ง (สถานที่สำหรับส่งสินค้า)" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-2 text-right control-label col-form-label">Link Location</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="link" placeholder="Link Location">
                                        </div>
                                    </div>
                                    <div class="form-group row">

    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ลูกค้าทั้งหมด</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                    <a href="customer-add.php"><button type="button" class="btn btn-success"><i class="mdi mdi-plus-circle"></i> เพิ่มรายชื่อลูกค้า</button></a><br><br>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo $row['Link']; ?>"><?php echo $row['Location']; ?></a></td>
                                                <td></td>
                                                <td><a href="customer-detail.php?viewid=<?php echo htmlentities($row['ID']); ?>" class="view" data-toggle="tooltip"><button type="button" class="btn mb-1 btn-flat btn-outline-danger">รายละเอียด</button></td>
                                            </tr>
                                            <?php
                                            $cnt = $cnt + 1;
                                        }

...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "update  delivery set Sentdate='$sentdate',Cstatus='$cstatus',Remark='$remark',Mile='$mile',Time='$time',Image='$filesArray' where ID='$uid'");
}
?>
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <?php
            $uid = $_GET['updateid'];
            $ret = mysqli_query($con, "select * from delivery where ID='$uid'");
                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">อัปเดตสถานะ <span class="badge badge-primary"># <?php echo $row['Job']; ?></span> <span><?php if ($row['Cstatus'] == 'ลงคิว') {
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">อัปเดตสถานะการขนส่ง</h4>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">วันที่จัดส่งสำเร็จ</label>
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" name="sentdate" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">เลขไมล์</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="mile" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-2 text-right control-label col-form-label">เวลาที่จัดส่ง</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="time" readonly="readonly" value="<?php
                                        ...
                                        <h4>เพิ่มรูปภาพการจัดส่ง</h4>
                                        <input type="file" name="fileImg[]" accept=".jpg, .jpeg, .png, .PNG" required multiple> <br>
                                        <!--<div class="form-group row">
                                        <label for="fname" class="col-sm-2 text-right control-label col-form-label">ปัญหาการจัดส่ง</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="problem" placeholder="problem" disabled>
                                        </div>
                                    </div>-->
                                    </div>
                                </div>
